...
L'assortativité par degré est globalement positive (moyenne $\approx$ 0,06). Cela suggère une légère tendance des nœuds très connectés à être reliés entre eux, bien que ce phénomène soit modéré comparé à d'autres types de réseaux (comme les réseaux de collaboration scientifique).
